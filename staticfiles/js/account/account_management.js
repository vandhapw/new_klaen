    ...
    $('#login-submit').click(function(e) {
      ...
      $.ajax({
        ...
        error: function(error) {
          // Accessing JSON error message from the response
          var errorMessage = error.responseJSON && error.responseJSON.message ? error.responseJSON.message : 'Sorry, User Not Found!!';

          // Show the error message using showLoading or other alert methods
          showLoading(errorMessage, autoclose = true);

          //   showLoading(error.message, autoclose=true);
          //   $('#error_alert').text(error.response).addClass('alert alert-danger').show();
